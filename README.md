<div align="center">
  <img src="https://github.com/RanaTarunn/SheGuard/blob/master/banner.png" width="100%" alt="Banner">
</div>
...
- After that, go to your project's [Firebase Console](https://console.firebase.google.com/) > `Settings icon` (beside Project Overview) > `Project Settings` > `Service accounts`:
  - Generate new private key, rename the key to `service_account.json` and paste the file in [/res/raw](https://github.com/RanaTarunn/SheGuard/tree/master/app/src/main/res/raw)

- Open the `service_account.json` file:
  - Copy the `project_id` of your private key and paste it in [NotificationAPI.java](https://github.com/RanaTarunn/SheGuard/blob/master/app/src/main/java/com/android/sheguard/api/NotificationAPI.java)
...
Email: rana.tarun.hr@diu.edu.bd

## Donation 💰

If this project help you reduce time to develop, you can give me a cup of coffee :)

<a href="https://www.buymeacoffee.com/DrDisagree"><img src="https://github.com/RanaTarunn/Iconify/blob/beta/.github/resources/bmc-button.png" width="30%" alt="Buy me a coffee" /></a>
